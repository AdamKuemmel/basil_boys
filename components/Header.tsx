    ...
    <div className="sticky z-10 bg-transparent">
      <nav className="px-4 py-5 sm:py-6 sm:px-7 2xl:container 2xl:mx-auto">
        ...
        <div className="flex justify-between ">
          <div className="flex-row items-center hidden p-2 space-x-6 border h-14 rounded-xl border-slate-500 bg-slate-500/50 backdrop-blur-sm sm:flex">
            <svg
          ...
          <div
            ...
            className="items-center justify-center cursor-pointer h-14 focus:outline-none focus:ring-2 focus:ring-gray-800 focus:ring-offset-2 sm:hidden "
          >
            <svg
        ...
        <div
          id="MobileNavigation"
          className={`${show ? 'block' : 'hidden'} mx-auto mt-4 sm:hidden`}
        >
          ...
          <div className="flex flex-col gap-4 mx-auto mt-4 w-80 ">
            <button className="flex items-center justify-center w-full h-10 space-x-2 text-sm font-normal leading-3 text-indigo-700 duration-100 duration-150 bg-indigo-600 bg-opacity-0 border border-indigo-700 rounded-md hover:bg-gray-200 hover:opacity-100 focus:bg-gray-200 focus:outline-none">
              Sign Up
            </button>
            <button className="flex items-center justify-center w-full h-10 space-x-2 text-sm font-normal leading-3 text-white duration-150 bg-indigo-700 rounded-md hover:bg-indigo-600 focus:bg-indigo-600 focus:outline-none focus:ring-2 focus:ring-indigo-700 focus:ring-offset-2">
              Sign In
            </button>
          </div>
        </div>
